...
#include <cmath>
#include <string>
// screen and grid dimension
const int SCREEN_WIDTH = 800;
const int SCREEN_HEIGHT = 800;
const int GRID_SIZE = 20;
// maximum snake length using array
...
int main(int argc, char *argv[])
{
    ...
    snakeY[0] = 300; // Head
    snakeX[1] = 270;
    snakeY[1] = 300; // Body segment 1
    snakeX[2] = 240;
    snakeY[2] = 300;       // Body segment 2
    ...
    // clean up resource and close SDL2
